...
public class NoticeController {
	...
	public String noticeInsert(@RequestParam("not_file1") MultipartFile mutiFile, Notice notice,
			HttpServletRequest request, Model model) throws Exception { // 매개변수 : 세션 객체 필요(관리자)
...
//		notice.setNoticeFileName(noticeFileName);
	...
	public String noticeUpdate(@RequestParam("not_file1") MultipartFile mutiFile, Notice notice,
