...
//	//관리자 목록 틀
	...
	// 관리자 직위 해제 
	@RequestMapping(value = "managerDown", method = RequestMethod.POST)
    ...
    public String selectWaitAccept(Business business, Model model) throws Exception {
        ...
        return "manager/selectWaitAccept";
    }
    
	//사업체 승인
	@RequestMapping(value = "businessAccept")
	public String businessAccept(Business business, Model model) throws Exception {
		String bus_no = business.getBus_no();
		System.out.println("승인 요청자 bus_no : "+bus_no);
