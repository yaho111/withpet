    ...
    <div class="container">
        ...
        <div id="login_menu" class="body-menu">
            ...
            <c:if test="${sessionScope.role == 'master' || sessionScope.role == 'notice'}">
                ...
                <input type="button" class="btn btn-outline-secondary" value="삭제"
                       onClick="location.href='noticeDelete?not_no=${notice.not_no}&pageNum=${paging.currentPage}' ">
            </c:if>
            <!-- 사용자 + 관리자 -->
        ...
        <form name="not_form" id="not_form">
            ...
            <c:if test="${sessionScope.id != null}">
                ...
                <input type="button" value="확인" id="notReInsert" class="btn btn-outline-secondary">
            </c:if>
        </form>
    </div>
