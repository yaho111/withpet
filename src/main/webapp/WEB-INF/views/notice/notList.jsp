...
<nav>
	...
	<c:if test="${not empty keyword}">
		...
		<c:if test="${paging.startPage > paging.rowPerPage }">
			<li><a class="page-link" href="noticeList?pageNum=${paging.startPage - 1}&search=${search}&keyword=${keyword}">
				< 
			</a></li>
		</c:if>
		...
		<c:if test="${paging.endPage < paging.totalPage}">
			<li><a class="page-link" href="noticeList?pageNum=${paging.endPage + 1}&search=${search}&keyword=${keyword}">
				> 
			</a></li>
		</c:if>
