    ...
    <div class="container-body">
        ...
        <table class="table">
            <tr>
                <th>이름</th>
                <td>
                    <input name="pet_name" id="pet_name" size="14" class="form-control"/>
                </td>
            </tr>
            <tr>
                <th>종류</th>
            ...
            <tr>
                <th>품종</th>
                <td>
                    <input name="pet_kind" id="pet_kind" class="form-control"/>
                </td>
            </tr>
            <tr>
                <th>성별</th>
            ...
            <tr>
                <th>생년월일</th>
                <td>
                    <input name="pet_birth" id="pet_birth" class="form-control" type="date"/>
                </td>
            </tr>
            <tr>
                <th>프로필 사진</th>
            ...
            <tr>
                <th>특이사항</th>
                <td>
                    <textarea name="pet_info" id="pet_info" class="form-control"></textarea>
                </td>
            </tr>
